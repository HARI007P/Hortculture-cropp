...
<a href="{{ route('markets.index') }}" class="btn btn-secondary back-btn">
    <i class="fas fa-arrow-left"></i> <!-- Using FontAwesome for left arrow icon -->
</a>
    <div class="market-detail-card">
        <img src="{{ asset($market['image']) }}" alt="{{ $market['name'] }}" class="market-image">
        ...
        <p><strong>✅ Facilities:</strong> {{ $market['facilities'] }}</p>
